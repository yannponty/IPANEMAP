...
\section{Detailed results on Cordero~\emph{et al} dataset}
...
\begin{adjustbox}{max width=1\textwidth}
 \begin{tabular}{r|HHHHHHHH|HHHH|HHHH}\toprule
 	                              & \multicolumn{8}{c}{ \OurTool{}}                                                                                                                                                                                                           & \multicolumn{4}{c}{RNAfold MFE}                                                                          & \multicolumn{4}{c}{RNAfold MEA}                                                                         \\
 	%                             & \multicolumn{3}{l}{ GM }                                                      & \multicolumn{3}{l}{ GM }                                                              & \multicolumn{3}{l}{ GM }                                                                    & \multicolumn{3}{l}{ GM }                                                        & \multicolumn{3}{l}{ GM }                                                     & \multicolumn{3}{l}{ GM }       & \multicolumn{3}{l}{ GM } \\ \toprule
\midrule
\textbf{CMCT} & & \B & & & & \B & \B & \BR & & & \B & & & & \B & \\
\textbf{NMIA} & & & \B & & \B & & \B & \BR & & & & \BR & & & & \B \\
\textbf{DMS}  & & & & \B & \B & \B & & \BR & & \B & & & & \B & & \\
 \midrule
...
\section{Detailed results on Hadjin~\emph{et al} dataset}
...
\begin{table}[H]
\begin{adjustbox}{max width=.9\textwidth,max totalheight=\textheight,keepaspectratio}
...
\newpage 
\section{Detailed results of Lariat capping ribozyme from {\itshape Didymium iridis}}
...
\begin{tabular}{lHH}
 & \multicolumn2c{Distance of probing profile}\\
Condition & \multicolumn1c{vs prediction}&\multicolumn1c{vs native}\\
\toprule
1M7ILUMg & 0.234 & 0.2872\\
1M7ILU &	0.2784 & 0.2961\\
NMIAMg &	0.2606 & 0.2518\\
NMIA &	0.2961 & 0.3316\\
1M7ILU3Mg &	0.4291 & 0.3936\\
NMIAMgCE &	0.4291 & 0.3404\\
NaiMg 	& 0.3493 & 0.305\\
BzCNMg & 	0.3759 & 0.2429\\
1M7MgCE &	0.4379 & 0.3759\\
CMCTMg &	0.4911 & 0.4113\\
1M7ILU3 &	0.2961 & 0.3404\\
DMSMg &	0.3493 & 0.3227\\
...
%\toprule
 ...
 \midrule
Native&1M7ILU&1M7ILUMg&1M7MgCE&NaiMg\\
structure &+NMIAMg&+1M7ILU3Mg&+NMIAMgCE&+CMCTMg\\
\end{tabular}
