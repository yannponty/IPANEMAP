...
\toprule
\Bull{C}~\OneMSevILUMg & 0.234 & 0.2872\\
\Bull{A}~\OneMSevILU &	0.2784 & 0.2961\\
\Bull{A}~\NMIAMg &	0.2606 & 0.2518\\
\Bull{A}~\NMIA &	0.2961 & 0.3316\\
\Bull{C}~\OneMSevILUThreeMg &	0.4291 & 0.3936\\
\Bull{E}~\NMIAMgCE &	0.4291 & 0.3404\\
\Bull{G}~\NAIMg 	& 0.3493 & 0.305\\
\Bull{H}~\BzCNMg & 	0.3759 & 0.2429\\
\Bull{E}~\OneMSevMgCE &	0.4379 & 0.3759\\
\Bull{G}~\CMCTMg &	0.4911 & 0.4113\\
\Bull{D}~\OneMSevILUThree &	0.2961 & 0.3404\\
\Bull{F}~\DMSMg &	0.3493 & 0.3227\\
\Bull{B}~\NMIACE 	&0.2695 &0.2518 \\
\Bull{B}~\OneMSevCE &	0.3582 & 	0.3316\\
\Bull{B}~\BzCN &	0.4911 & 	0.4734\\
\Bull{B}~\NAICE &	0.4025 &0.4025\\
\bottomrule
\end{tabular}
\end {center}
