	...
	\begin{table}[h]
		...
		\begin{adjustbox}{max width=.5\textwidth}
			\begin{tabular}{@{}lllllHH@{}}
				...
				Clust. \tikzcircle[black, fill=SeaGreen]{3pt} &Clust. \tikzcircle[black, fill=gray]{3pt}& Clust.  \tikzcircle[black, fill=OliveGreen]{3pt} & Clust. \tikzcircle[black, fill=Bittersweet]{3pt}&  & \multicolumn1c{+Nai}& \multicolumn1c{-Nai}\\
				\midrule
