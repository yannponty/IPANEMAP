...
\noindent \OurTool{} combines statistical sampling, unsupervised machine learning, and multi-objective optimization, to produce secondary structure models that are both stable and well-supported by experimental evidences. The analysis of several reactivity, both publicly available and specifically produced experimentally, demonstrates the good performances of \OurTool, even in a mono probing setting. It confirms the potential of integrating multiple sources of probing data, leading to recommendations for the experimental design of informative probing assays. 
