...
A similar change of performances can be observed in the comparison of the average MCC of mutation-inducing reagents (78\%) with stop-inducing ones (66\%). 
...
\begin{table}
	...
	{\centering
		...
		\begin{tabular}{@{}lcccHHH}
			...
			1M7ILUMg                     &\Bull{C}& \Mut  &      \Mg      & 0.85                                  & 0.82                 & 0.82                 \\
			1M7ILU                      &\Bull{A}& \Mut  &     \NoMg     & 0.84                                  & 0.82                 & 0.84                 \\
			NMIAMg                      &\Bull{A}& \Mut  &      \Mg      & 0.81                                  & 0.80                 & 0.80                 \\
			NMIA                        &\Bull{A}& \Mut  &     \NoMg     & 0.80                                  & 0.69                 & 0.69                 \\
			1M7ILU3Mg                   &\Bull{C}& \Mut  &      \Mg      & 0.74                                  & 0.75                 & 0.75                 \\
			NMIAMgCE                    &\Bull{E}& \Stop &      \Mg      & 0.73                                  & 0.72                 & 0.73                 \\
			NAIMg                       &\Bull{G}& \Stop &      \Mg      & 0.73                                  & 0.68                 & 0.70                 \\
			BzCNMg                      &\Bull{H}& \Stop &      \Mg      & 0.71                                  & 0.68                 & 0.54                 \\
			1M7MgCE                     &\Bull{E}& \Stop &      \Mg      & 0.70                                  & 0.69                 & 0.70                 \\
			CMCTMg                      &\Bull{G}& \Stop &      \Mg      & 0.70                                  & 0.68                 & 0.73                 \\
			1M7ILU3                     &\Bull{D}& \Mut  &     \NoMg     & 0.64                                  & 0.56                 & 0.61                 \\
			DMSMg                       &\Bull{F}& \Stop &      \Mg      & 0.63                                  & 0.66                 & 0.67                 \\
			NMIACE                      &\Bull{B}& \Stop &     \NoMg     & 0.61                                  & 0.60                 & 0.60                 \\
			1M7CE                       &\Bull{B}& \Stop &     \NoMg     & 0.60                                  & 0.61                 & 0.61                 \\
			BzCN                        &\Bull{B}& \Stop &     \NoMg     & 0.60                                  & 0.59                 & 0.59                 \\
			NAI                         &\Bull{B}& \Stop &     \NoMg     & 0.60                                  & 0.59                 & 0.59                 \\ \midrule
			Avg Technology              & & \Mut  &      $\star$       & 0.78                                  & 0.74                 & 0.75                 \\
			                            & & \Stop &      $\star$       & 0.66                                  & 0.65                 & 0.65                 \\
			Avg -/+ Mg$^{2+}$           & &  $\star$   &     \NoMg     & 0.67                                  & 0.64                 & 0.65                 \\
			                            & &  $\star$   &      \Mg      & 0.73                                  & 0.72                 & 0.715                \\ \midrule
			{\bfseries Average overall} & &  $\star$   &      $\star$       & 0.705                                 & 0.68                 & 0.685                \\ \bottomrule& 
		\end{tabular}
		\end{adjustbox}\\[1em]}
	...
	{\centering
		\begin{adjustbox}{max width=\linewidth}
			\begin{tabular}{@{}lHH@{}}
				\toprule
				& \multicolumn{2}{@{}c@{}}{MCC}                    \\
				Description                            & \multicolumn1c{Joint} & \multicolumn1{c@{}}{Mono} \\ \midrule
				{Cluster \Bull{A}}                     &  \\
				NMIAMg, 1M7ILU, NMIA                   & 0.80                   & 0.82                      \\
				NMIAMg, 1M7ILU                         & 0.82                   & 0.82                      \\
				1M7ILU, NMIA                           & 0.82                   & 0.82                      \\
				NMIAMg,  NMIA                          & 0.80                   & 0.80                      \\ \midrule
				{Cluster \Bull{B}}                     &  \\
				Nai, BzCN, 1M7CE, NMIACE               & 0.60                   & 0.60                      \\
				Nai, BzCN, 1M7CE                       & 0.60                   & 0.60                      \\
				Nai, BzCN, NMIACE                      & 0.61                   & 0.60                      \\
				Nai, 1M7CE, NMIACE                     & 0.61                   & 0.60                      \\
				BzCN, 1M7CE, NMIACE                    & 0.61                   & 0.60                      \\
				Nai, BzCN                              & 0.60                   & 0.60                      \\
				Nai, 1M7CE                             & 0.59                   & 0.60                      \\
				Nai, NMIACE                            & 0.60                   & 0.60                      \\
				BzCN, 1M7CE                            & 0.61                   & 0.60                      \\
				BzCN,NMIACE                            & 0.60                   & 0.60                      \\
				1M7CE, NMIACE                          & 0.62                   & 0.61                      \\ \midrule
				{Cluster \Bull{C}}                     &  \\
				1M7ILUMg, 1M7ILU3Mg                    & 0.82                   & 0.80                      \\ \midrule
				{Cluster \Bull{E}}                     &  \\
				1M7MgCE, NMIAMgCE                      & 0.73                   & 0.72                      \\ \midrule
				{Cluster \Bull{G}}                     &  \\
				NaiMg, CMCTMg                          & 0.73                   & 0.72                      \\ \bottomrule
				%				\midrule
...
As expected, compared to the average MCC over associated mono-probing analyses, similar conditions induce an MCC change of limited magnitude (between -2\% and +2\%), leading to an overall modest improvement (+0.2\% average MCC). This is consistent with the notion that supplementing a probing-based modeling with compatible conditions provides very little additional information, leading to a limited contribution of similar conditions.
...
Finally, the consideration of four triplets of diverse conditions allow us to reach our best prediction, achieving 85.3\% MCC. Meanwhile, considering the 16 conditions together yields a 80\% MCC value, increasing to 83\% in the absence of the four outlier conditions of cluster \Bull{B}. These results confirm that the strategy used by \OurTool{} is able to exploit the complementary information provided by multiple conditions, contributing to better predictions.
	...
	\begin{adjustbox}{max width=\linewidth}
		\begin{tabular}{@{}llllHHHH@{}}
			\toprule
			\multicolumn{4}{@{}l@{}}{Conditions}                                    & \MCB{MCC (-NAI)} & \MCB{MCC (+NAI)} \\
			Clust. \Bull{A} & Clust. \Bull{C} & Clust.  \Bull{E} & Clust. \Bull{G}   & \MC{Joint} & \MC{Mono}  & \MC{Joint}       & \MC{Mono}      \\ \midrule
			NMIAMg          & 1M7ILUMg        & 1M7MgCE          & NaiMg             & 0.84       & 0.72       & 0.83             & 0.71           \\
			NMIAMg          & 1M7ILUMg        & 1M7MgCE          & CMCTMg            & 0.75       & 0.72       & 0.82             & 0.71           \\
			NMIAMg          & 1M7ILUMg        & NMIAMgCE         & NaiMg             & 0.79       & 0.73       & 0.82             & 0.71           \\
			NMIAMg          & 1M7ILUMg        & NMIAMgCE         & CMCTMg            & 0.82       & 0.72       & 0.60             & 0.71           \\
			NMIAMg          & 1M7ILU3Mg       & 1M7MgCE          & NaiMg             & 0.70       & 0.71       & 0.60             & 0.70           \\
			NMIAMg          & 1M7ILU3Mg       & 1M7MgCE          & CMCTMg            & 0.70       & 0.70       & 0.72             & 0.69           \\
			NMIAMg          & 1M7ILU3Mg       & NMIAMgCE         & NaiMg             & 0.72       & 0.71       & 0.74             & 0.70           \\
			NMIAMg          & 1M7ILU3Mg       & NMIAMgCE         & CMCTMg            & 0.75       & 0.71       & 0.60             & 0.70           \\
			1M7ILU          & 1M7ILUMg        & 1M7MgCE          & NaiMg             & 0.82       & 0.73       & 0.75             & 0.71           \\
			1M7ILU          & 1M7ILUMg        & 1M7MgCE          & CMCTMg            & 0.84       & 0.72       & 0.60             & 0.71           \\
			1M7ILU          & 1M7ILUMg        & NMIAMgCE         & NaiMg             & 0.73       & 0.73       & 0.60             & 0.72           \\
			1M7ILU          & 1M7ILUMg        & NMIAMgCE         & CMCTMg            & 0.82       & 0.73       & 0.82             & 0.71           \\
			1M7ILU          & 1M7ILU3Mg       & 1M7MgCE          & NaiMg             & 0.84       & 0.71       & 0.60             & 0.70           \\
			1M7ILU          & 1M7ILU3Mg       & 1M7MgCE          & CMCTMg            & 0.70       & 0.71       & 0.84             & 0.70           \\
			1M7ILU          & 1M7ILU3Mg       & NMIAMgCE         & NaiMg             & 0.74       & 0.72       & 0.60             & 0.70           \\
			1M7ILU          & 1M7ILU3Mg       & NMIAMgCE         & CMCTMg            & 0.74       & 0.71       & 0.75             & 0.70           \\
			NMIA            & 1M7ILUMg        & 1M7MgCE          & NaiMg             & 0.82       & 0.72       & 0.75             & 0.71           \\
			NMIA            & 1M7ILUMg        & 1M7MgCE          & CMCTMg            & 0.83       & 0.72       & 0.82             & 0.70           \\
			NMIA            & 1M7ILUMg        & NMIAMgCE         & NaiMg             & 0.73       & 0.73       & 0.59             & 0.71           \\
			NMIA            & 1M7ILUMg        & NMIAMgCE         & CMCTMg            & 0.82       & 0.72       & 0.82             & 0.71           \\
			NMIA            & 1M7ILU3Mg       & 1M7MgCE          & NaiMg             & 0.73       & 0.71       & 0.82             & 0.69           \\
			NMIA            & 1M7ILU3Mg       & 1M7MgCE          & CMCTMg            & 0.70       & 0.70       & 0.73             & 0.69           \\
			NMIA            & 1M7ILU3Mg       & NMIAMgCE         & NaiMg             & 0.74       & 0.71       & 0.68             & 0.70           \\
			NMIA            & 1M7ILU3Mg       & NMIAMgCE         & CMCTMg            & 0.74       & 0.71       & 0.73             & 0.69           \\ \midrule
			                &                 &                  & Average           & 0.77       & 0.72       & 0.72             & 0.70           \\ \bottomrule
		\end{tabular}
	\end{adjustbox}\\
...
\subsection{Supplementing with pointwise mutants increases prediction quality}
...
This approach may appear misguided, since single point mutants are expected to adopt different structures than the wild-type sequence. In fact, the conformational changes induced by mutations precisely constitute the signal that is exploited by downstream modeling pipelines~\cite{Cordero2015}. However, those changes are typically local, and the limited influence of outliers on \OurTool{} fuels our hope that the benefit of including independently-produced conditions will outweigh the impact of noise introduced by local changes.

We selected 100 random subsets consisting of 1, 2, 3 and 10 mutants, which we supplemented with the original wild-type sequence (WT).
...
For the WT, our results are reproducible and, in 94\% out of the 100 runs, we obtained a structure having MCC between 60.5\% and 61\%. Interestingly, the remaining 6\% of the runs present improved MCC values, ranging from 76\% to 78\%, suggesting the existence of a close suboptimal.
