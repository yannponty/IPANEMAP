...
\newcommand{\Bull}[1]{\raisebox{1pt}{\tikzcircle[black, fill=cluster#1]{3pt}}}

\newcommand{\BullLab}[1]{{\sf\bfseries#1}~\Bull{#1}}
...
A visual inspection of Figure~\ref{fig:PCA} suggests the presence of 8 clusters. In order to objectively build groups of compatible conditions, we performed a k-mean clustering using \Software{scikit-learn}, setting k to 8, and obtained the clusters highlighted in Figures~\ref{fig:biclustering} and \ref{fig:PCA}.  We obtain 2 \Def{singleton clusters} restricted to a single condition (\Bull{D}~\{1M7ILU3\} and \Bull{H}~\{BzCNMg\}) and six \Def{composite clusters}, consisting of 2 conditions (\Bull{C}~\{1M7ILU3Mg, 1M7ILUMg\}, \Bull{G}~\{CMCTMg, NaiMg\}, \Bull{E}~\{NMIAMgCE,1M7MgCE\}, and \Bull{F}~\{DMSMg, probing-free\}), 3 conditions (\Bull{A}~\{1M7ILU, NMIA, NMIAMg\}) and 4 conditions (\Bull{B}~\{1M7CE, NMIACE, BzCN, Nai\}) respectively.  The predicted clusters are generally consistent with the ordering resulting from a spectral biclustering, implemented in \Software{scikit-learn} and executed with default parameters, as illustrated by Figure~\ref{fig:glycine_example}. 
	...
	{\centering
		%\begin{adjustbox}{max width=.5\textwidth}
			\begin{tabular}{@{}lHH@{}}
				\toprule
				& \multicolumn2c{MCC}\\
				Description & \multicolumn1c{Multi}& \multicolumn1{c@{}}{Avg}\\
				\midrule	
				%{\em Similar conditions}\\
			
\Bull{A} NMIAMg, 1M7ILU, NMIA	&	.8	&	.82	\\
NMIAMg, 1M7ILU	&	.82	&	.825	\\
1M7ILU, NMIA	&	.82	&	.82	\\
NMIAMg,  NMIA	&	.8	&	.805	\\

\midrule
\Bull{B} Nai, BzCN, 1M7CE, NMIACE	&	.6	&	.6	\\
Nai, BzCN, 1M7CE	&	.6	&	.6	\\
...
1M7CE, NMIACE	&	.62	&	.605	\\		
\midrule		
\Bull{C} 1M7ILUMg, 1M7ILU3Mg	&	.82	&	.795	\\
\midrule		
\Bull{E} 1M7MgCE, NMIAMgCE	&	.73	&	.715	\\
\midrule
\Bull{G} NaiMg, CMCTMg	&	.73	&	.715	\\
	...
	\begin{table}[h]
		...
		\begin{adjustbox}{max width=\linewidth}
			\begin{tabular}{@{}lllllHH@{}}
				...
				Clust. \Bull{A} &Clust. \Bull{C}& Clust.  \Bull{E} & Clust. \Bull{G}&  & \multicolumn1c{+Nai}& \multicolumn1c{-Nai}\\
				\midrule
	...
	\begin{table*}
		\begin{adjustbox}{max width=\linewidth}
			\begin{tabular}{@{}ccccccccc@{}}
				\toprule
				\Bull{C}1M7ILUMg&	\tikzcircle[black, fill=Orchid]{3pt} 1M7ILU3 & \Bull{A}1M7ILU&	\tikzcircle[black, fill=blue]{3pt} DMSMg& \tikzcircle[black, fill=OliveGreen]{3pt} NMIAMgCE& \tikzcircle[black, fill=Bittersweet]{3pt} CMCTMg & \tikzcircle[black, fill=SeaGreen!40]{3pt} BzCNMg& MCC & Mono-Avg\\
				\midrule
				\star & &\star &\star & & &&\textbf{.853}&.77\\
				\star & & \star&  & \star&&& \textbf{.853}&.81\\
				\star & && \star& & \star &&\textbf{.853} &.73\\
				\star &\star &&&&&  \star&\textbf{.853} &.73\\
				\midrule
				\star&\star&\star&\star&\star&\star&\star& .83&.73\\
