...
\ypi{Dans la mesure où l'intro est courte, et étant donné le titre, je ne pense pas que sa présence en Mat Met limite  sur visibilité. En plus, c'est typiquement là où tu le trouves d'habitude dans ce type de papier (cf Rsample).}
...
\begin{figure}
	...
	\caption{Discretized ensemble distance induced by conditions. Conditions ordered by spectral biclustering. Conditions regrouped within clusters by k-mean clustering appear as blocks on the x and y axis.\bsi{pourquoi les clusters E et F ne sont ils pas regroupés comme les autres?}}\label{fig:biclustering}
\end{figure}
