...
\begin{figure*}
	...
	\caption{Model of the Lariat capping ribozyme in {\itshape Didymium iridis} (A -- Meyer\etal\cite{Meyer2014}), pseudoknot-free secondary structure as annotated by \Software{DSSR} (B -- pseudoknot ommitted) and \OurTool first-ranking prediction (C.) from 8 maximally-diverging probing conditions (NMIAMg, 1M7ILU3Mg, NAIMg, 1M7, CMCTMg,1M7ILU3,1M7Mg). }
\end{figure*}
...
%
	...
	\caption{Some triplets of conditions that achieve the best observed MCC.}\label{fig:best}
\end{table}
%\begin{table}
%	\centering
